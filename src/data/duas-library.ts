...
export const libraryDuas: LibraryDua[] = [
  ...
  },
  {
    ...
    note: null,
    crossRef: null,
    tags: ["refuge", "muawwidhatayn", "short surah"],
    hajjLocation: false,
    instructionOnly: false,
  },
  {
    id: "Q96",
    category: "quranic",
    title: "Surah an-Nas — refuge with the Lord of mankind (full)",
  ...
  },
  {
    id: "Q97",
    category: "quranic",
    title: "Shu'ayb عليه السلام: My success is only with Allah",
    arabic: "قَالَ يَـٰقَوْمِ أَرَءَيْتُمْ إِن كُنتُ عَلَىٰ بَيِّنَةٍ مِّن رَّبِّى وَرَزَقَنِى مِنْهُ رِزْقًا حَسَنًا ۚ وَمَآ أُرِيدُ أَنْ أُخَالِفَكُمْ إِلَىٰ مَآ أَنْهَىٰكُمْ عَنْهُ ۚ إِنْ أُرِيدُ إِلَّا ٱلْإِصْلَـٰحَ مَا ٱسْتَطَعْتُ ۚ وَمَا تَوْفِيقِىٓ إِلَّا بِٱللَّهِ ۚ عَلَيْهِ تَوَكَّلْتُ وَإِلَيْهِ أُنِيبُ",
  ...
  },
  {
    id: "Q98",
    category: "quranic",
    title: "Ibrahim عليه السلام: I have turned my face to the Creator",
    arabic: "إِنِّى وَجَّهْتُ وَجْهِىَ لِلَّذِى فَطَرَ ٱلسَّمَـٰوَٰتِ وَٱلْأَرْضَ حَنِيفًا ۖ وَمَآ أَنَا۠ مِنَ ٱلْمُشْرِكِينَ",
    transliteration: "innī wajjahtu wajhiya lilladhī faṭara l-samāwāti wal-arḍa ḥanīfan wamā anā mina l-mush'rikīna",
  ...
  },
  {
    id: "Q99",
    category: "quranic",
    title: "Salām — a word from a Merciful Lord (greeting in Paradise)",
    arabic: "سَلَـٰمٌ قَوْلًا مِّن رَّبٍّ رَّحِيمٍ",
