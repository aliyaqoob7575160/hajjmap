...
export const days: HajjDay[] = [
  ...
  { id: "9a", hijriLabel: "9 Dhul-Hijjah · Before Maghrib", name: "Yawm al-Arafah — Before Maghrib", subtitle: "From Mina to the Standing at Arafat", camera: { focus: ["mina", "arafat"], primary: "arafat" }, events: [
  ...
  { id: "9b", hijriLabel: "9 Dhul-Hijjah · After Maghrib", name: "Yawm al-Arafah — After Maghrib", subtitle: "From Arafat to the night at Muzdalifah", camera: { focus: ["arafat", "muzdalifah"], primary: "muzdalifah" }, events: [
