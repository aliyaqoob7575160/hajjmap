...
export const days: HajjDay[] = [
  ...
  { id: "9", hijriLabel: "9 Dhul-Hijjah", name: "Yawm al-Arafah", subtitle: "The Day of Arafah — the heart of Hajj", camera: { focus: ["mina", "arafat", "muzdalifah"], primary: "arafat" }, events: [
    ...
    { id: "9-3", time: "Afternoon until sunset", title: "The Standing (Wuquf) at Arafat",          locationId: "arafat",     description: "Facing the qiblah with raised hands, the pilgrim pours out supplication until sunset. This standing is the essential pillar of Hajj.", duaIds: ["arafahTahlil", "talbiyah", "H13", "P19"] },
    ...
    { id: "9-5", time: "On arrival",             title: "Pray Maghrib and Isha (combined)",        locationId: "muzdalifah", description: "On reaching Muzdalifah, Maghrib (3 rak'ahs) and Isha (shortened to 2 rak'ahs) are prayed together at the time of Isha, with a single adhan and two iqamahs, following the Prophet's practice.", duaIds: ["H14"] },
    { id: "9-6", time: "Through the night",      title: "Rest under the open sky",                 locationId: "muzdalifah", description: "Pilgrims spend the night at Muzdalifah. Staying until after midnight is required by the majority; remaining until Fajr follows the Prophet's example. The weak, women, and children may leave for Mina after the moon sets.", duaIds: ["muzdalifah", "H14"] },
  ...
  { id: "10", hijriLabel: "10 Dhul-Hijjah", name: "Yawm an-Nahr", subtitle: "The Day of Sacrifice — Eid al-Adha", camera: { focus: ["muzdalifah", "mina", "haram"], primary: "mina" }, events: [
    ...
    { id: "10-2", time: "Morning",         title: "Stone Jamrat al-Aqaba",              locationId: "mina",       description: "Seven pebbles are cast at the large pillar, saying 'Allahu Akbar' with each. The Talbiyah stops with the first pebble.", duaIds: ["jamarat", "H15"] },
